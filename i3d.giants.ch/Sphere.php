...
<head>
	<title>i3D - Sphere</title>
	<link rel="stylesheet" type="text/css" href="style.css" />
	<meta name="title" content="Sphere"/>
	<meta name="description" content="i3D file format specification. Shape: Sphere"/>
...
<tr>
	<td class="list" valign="top">shader</td>
	<td class="list" valign="top">Shader name</td>
	<td class="list" valign="top">String</td>
	<td class="list" valign="top">No</td>
</tr>
<tr>
	<td class="list" valign="top">radius</td>
	<td class="list" valign="top">Radius</td>
	<td class="list" valign="top">Float</td>
	<td class="list" valign="top">No</td>
</tr>
<tr>
	<td class="list" valign="top">center</td>
	<td class="list" valign="top">Center point (stored as: "x y z")</td>
	<td class="list" valign="top">String</td>
	<td class="list" valign="top">No</td>
</tr>
</table>
