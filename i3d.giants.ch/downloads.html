...
<head>
	<title>i3D - Downloads</title>
	<link rel="stylesheet" type="text/css" href="style.css" />
	<meta name="title" content="Downloads"/>
	<meta name="description" content="Downloads related to i3D. Import/Export source code, viewers and sample files."/>
...
<h3>1.2 Viewer</h3>
<ul>
	<li>i3d viewer, OpenGL, windows version, <a href="download/i3d_viewer_0.8.6.exe">i3d_viewer_0.8.6.exe</a> (Date: 01/03/05 Size: ~1521KB)</li>
</ul>
<br />
<h3>1.3 Import</h3>
<ul>
	<li>Loader example in java with source - for i3d version 1.0, <a href="download/java_i3d_loader_01_src.zip">java_i3d_loader_01_src.zip</a> (Date: 28/11/03 Size: ~1200KB)</li>
</ul>
<br />
<h3>1.4 Export</h3>
<ul>
