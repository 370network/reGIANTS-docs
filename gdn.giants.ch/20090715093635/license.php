...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en-US">
  <head>
	<title>GDN - GIANTS Game Engine License</title>
    <meta http-equiv="content-type" content="text/html; charset=iso-8859-1" />
	<meta http-equiv="expires" content="0">
	<meta http-equiv="cache-control" content="no-cache">
	<meta name="title" content="GIANTS Game Engine License"/>
...
<h1>GIANTS Game Engine License</h1>
<br /><br />
...
<tr>
    <td><b>GIANTS Engine v4 Non-Commercial License</b></td>
    <td align="right"><b>€185 EUR</b>&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
...
&nbsp;&nbsp;1-year updates<br />
&nbsp;&nbsp;GDN account<br />
&nbsp;&nbsp;Free publication possible<br />
&nbsp;&nbsp;Includes all GIANTS Engine v4 features and tools<br />
...
&nbsp;&nbsp;&nbsp;&nbsp;- GIANTS Script Debugger (v4.1.3)<br />
    ...
    <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
        ...
        <input type="hidden" name="hosted_button_id" value="4938266">
        <input type="image" src="https://www.paypal.com/en_US/CH/i/btn/btn_buynowCC_LG.gif" border="0" name="submit" alt="Buy Now">
...
<table width="600" border="1" rules="groups" bordercolor="silver" cellpadding="8">
<tr>
    <td><b>GIANTS Engine v4 Non-Commercial License 1-year Update</b></td>
    <td align="right"><b>€120 EUR</b>&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
<tr>
    <td valign="top">
&nbsp;&nbsp;1-year updates<br />
&nbsp;&nbsp;GDN account
    ...
    <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
        <input type="hidden" name="cmd" value="_s-xclick">
        <input type="hidden" name="hosted_button_id" value="4938335">
        <input type="image" src="https://www.paypal.com/en_US/CH/i/btn/btn_buynowCC_LG.gif" border="0" name="submit" alt="Buy Now">
        <img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">
    </form>
    </td>
...
<div class="oneThird">
	...
	<form method="POST" action="?r=244261943">
