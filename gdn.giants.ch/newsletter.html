...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en-US">
  <head>
	<title>GDN - Newsletter</title>
    <meta http-equiv="content-type" content="text/html; charset=iso-8859-1" />
	<meta http-equiv="expires" content="0">
	<meta http-equiv="cache-control" content="no-cache">
	<meta name="title" content="Newsletter"/>
	<meta name="description" content="GIANTS Developer Network - Newsletter"/>
...
Subscribe to our newsletter and keep yourself informed about updates and new releases of the GIANTS engine.
<br /><br />
<br />
	<form name="newsletter" method="POST" action="">
	<input type="hidden" name="greenstone" value="1" />

	<table border="0"><tr><td>
		<div style="font-size: 9pt;  font-weight:bold; padding-bottom:5px;">* First Name</div>
		<input style="border:1px solid #999999; color: #666666; width:256px; font-size: 9pt;" type="text" size="50" name="redstone" value="" /><br /><br />
		<div style="font-size: 9pt;  font-weight:bold; padding-bottom:5px;">* Last Name</div>
		<input style="border:1px solid #999999; color: #666666; width:256px; font-size: 9pt;" type="text" size="50" name="bluestone" value="" /><br /><br />
		<div style="font-size: 9pt;  font-weight:bold; padding-bottom:5px;">* E-Mail Address</div>
		<input style="border:1px solid #999999; color: #666666; width:256px; font-size: 9pt;" type="text" size="50" name="blackstone" value="" /><br /><br />
		<input style="border:1px solid black; background: silver; color: black; font-size: 9pt; font-weight:bold;" type="submit" name="foobar" value="&nbsp;Subscribe&nbsp;" />
	</td></tr></table>
...
<div class="oneThird">
	...
	<form method="POST" action="?r=397056159">
