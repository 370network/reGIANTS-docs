...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en-US">
  <head>
	<title>GIANTS Developer Network - Mesh Modelling with 3DS MAX</title>
    <meta http-equiv="content-type" content="application/xhtml+xml; charset=iso-8859-1" />
	<meta name="title" content="Mesh Modelling with 3DS MAX"/>
	<meta name="description" content="Artwork - Mesh Modelling with 3DS MAX"/>
...
<h1>Mesh Modelling with 3DS MAX</h1>
<ol style="list-style-type: decimal;">
	<li><a href="#Remove_useless_polygons">Remove useless polygons</a></li>
	<li><a href="#Generate_Normalmaps">Generate Normalmaps</a></li>
	<li><a href="#Flip_edges">Flip edges</a></li>
	<li><a href="#Remove_two_sided_materials">Remove two sided materials</a></li>
	<li><a href="#Fix_normals">Fix normals</a></li>
	<li><a href="#Merge_to_single_mesh">Merge to single mesh</a></li>
</ol>

<br /><br />

<a name="Remove_useless_polygons"><b>Remove useless polygons</b></a><br />

<p><img src="images/artwork/mesh_modelling1_max/unusedPolygons.jpg" alt="Remove useless polygons" /></p>
<br />
<br />

<a name="Generate_Normalmaps"><b>Generate Normalmaps</b></a><br />

<p>Generate Normalmaps for appropriate detail geometry</p>
...
<a name="Flip_edges"><b>Flip edges</b></a><br />

<p>Flip/turn edges to match topology.</p>

<p>Retriangulation of the mesh is a good starting point. Works only with Editable Polys</p>
<p><img src="images/artwork/mesh_modelling1_max/retriangulate.jpg" alt="retriangulate" /></p>

<p>Convert to Editable Mesh</p>
<p><img src="images/artwork/mesh_modelling1_max/convertToMesh.jpg" alt="convertToMesh" /></p>

<p>Flip/Turn individual edges</p>
<p>
   <img src="images/artwork/mesh_modelling1_max/flipEdges1.jpg" alt="Flip edges 1" />
...
<a name="Remove_two_sided_materials"><b>Remove two sided materials</b></a><br />

<p>Two sided materials are not supported and have to be replaced by an inverted copy of the affected faces.</p>
...
<ul>
    ...
    <li>Delete unused faces from clone</li>    
    <li>Attach clone to original</li>    
...
<a name="Fix_normals"><b>Fix normals</b></a><br />

<p>Fix normals to match topology. Use hard edges for cubic and soft edges for curved surfaces.</p>
...
<ul>
    ...
    <li>Fine tune normals manually</li>
</ul>
...
<a name="Merge_to_single_mesh"><b>Merge to single mesh</b></a><br />
