...
<ol type="none">
    ...
    <li><b>Chapter 05:</b> <a href="#editor">Debugger</a>
        <ol type="none">
            <li><a href="#debugger_overview">Overview</a></li>
            <li><a href="#debugger_ui">Interface</a>
                <ol type="none">
                    <li><a href="#debugger_ui_menu">Menu and Toolbars</a></li>
                    <li><a href="#debugger_ui_editor">Main text editor panel</a></li>
                    <li><a href="#debugger_ui_file">File browser panel</a></li>
                    <li><a href="#debugger_ui_variable">Variable overview panel</a></li>
                    <li><a href="#debugger_ui_additional">Additional information panel</a></li>
                </ol>
            </li>
            <li><a href="#debugger_tutorial">Tutorial</a>
                <ol type="none">
                    <li><a href="#debugger_tutorial_setup">Setup</a></li>
                    <li><a href="#debugger_tutorial_debugging">Debugging</a></li>
                    <li><a href="#debugger_tutorial_stepping">Stepping</a></li>
                </ol>
            </li>
            <li><a href="#debugger_keys">Keyboard short-cuts</a></li>
        </ol>
    </li>

    <li><b>Chapter 06:</b> <a href="#exporter">Exporter</a>
        <ol type="none">
            <li>
    ...
    <li><b>Chapter 07:</b> <a href="#artwork_guide">Content Creation - Artwork Guide</a>
        <ol type="none">
    ...
    <li><b>Chapter 08:</b> <a href="#i3d">I3D Format</a>
        <ol type="none">
...
<h3>setRootNode</h3>
<b>Description</b><br />
<blockquote>Set scenegraph root node used by the given viewport</blockquote>
<br />
<b>Definition</b><br />
<blockquote><i>function setRootNode(integer rootNodeId, integer viewportIndex)</i></blockquote>
<br />
<b>Arguments</b><br />
<blockquote><table cellpadding="3" border="1" style="border-collapse:collapse">
<tr><td><i>integer</i></td><td><i>rootNodeId</i></td><td>id of new root node</td></tr>
<tr><td><i>integer</i></td><td><i>viewportIndex</i></td><td>the index of the viewport [0-7]</td></tr>
</table></blockquote>
<br />
<br /><br /><br />        
...
<h3>getRootNode</h3>
<b>Description</b><br />
<blockquote>Get scenegraph root node used by the given viewport</blockquote>
<br />
<b>Definition</b><br />
<blockquote><i>function getRootNode(integer viewportIndex)</i></blockquote>
<br />
<b>Arguments</b><br />
<blockquote><table cellpadding="3" border="1" style="border-collapse:collapse">
<tr><td><i>integer</i></td><td><i>viewportIndex</i></td><td>the index of the viewport [0-7]</td></tr>
...
<h3>setCamera</h3>
<b>Description</b><br />
<blockquote>Set currently used camera by the given viewport</blockquote>
<br />
<b>Definition</b><br />
<blockquote><i>function setCamera(integer cameraId, integer viewportIndex)</i></blockquote>
<br />
<b>Arguments</b><br />
<blockquote><table cellpadding="3" border="1" style="border-collapse:collapse">
...
<h3>getCamera</h3>
<b>Description</b><br />
<blockquote>Get currently used camera by the given viewport</blockquote>
<br />
<b>Definition</b><br />
<blockquote><i>function getCamera(integer viewportIndex)</i></blockquote>
<br />
<b>Arguments</b><br />
<blockquote><table cellpadding="3" border="1" style="border-collapse:collapse">
<tr><td><i>integer</i></td><td><i>viewportIndex</i></td><td>the index of the viewport [0-7]</td></tr>
...
<h3>setViewport</h3>
<b>Description</b><br />
<blockquote>Set the dimensions of the given viewport</blockquote>
<br />
<b>Definition</b><br />
<blockquote><i>function setViewport(integer viewportIndex, float left, float top, float width, float height)</i></blockquote>
<br />
<b>Arguments</b><br />
<blockquote><table cellpadding="3" border="1" style="border-collapse:collapse">
<tr><td><i>integer</i></td><td><i>viewportIndex</i></td><td>the index of the viewport [0-7]</td></tr>
<tr><td><i>float</i></td><td><i>left</i></td><td>the start position from the left side [0-1]</td></tr>
<tr><td><i>float</i></td><td><i>top</i></td><td>the start position from the top side [0-1]</td></tr>
<tr><td><i>float</i></td><td><i>width</i></td><td>the width of the viewport [0-1]</td></tr>
<tr><td><i>float</i></td><td><i>height</i></td><td>the height of the viewport [0-1]</td></tr>
</table></blockquote>
<br />
<b>Notes</b><br />
<blockquote><i>since v4.1.5</i></blockquote>
...
<b>Arguments</b><br />
<blockquote><table cellpadding="3" border="1" style="border-collapse:collapse">
<tr><td><i>integer</i></td><td><i>shapeId</i></td><td>shape id</td></tr>
...
<br />
<b>Definition</b><br />
<blockquote><i>function setEmittingState(integer particleSystemId, boolean state)</i></blockquote>
<br />
<b>Arguments</b><br />
<blockquote><table cellpadding="3" border="1" style="border-collapse:collapse">
<tr><td><i>integer</i></td><td><i>particleSystemId</i></td><td>particle system id</td></tr>
<tr><td><i>boolean</i></td><td><i>state</i></td><td>if true, new particles are emitted</td></tr>
</table></blockquote>
<br />
<br /><br /><br />
...
<br />
<b>Definition</b><br />
<blockquote><i>function resetNumOfEmittedParticles(integer particleSystemId)</i></blockquote>
<br />
<b>Arguments</b><br />
<blockquote><table cellpadding="3" border="1" style="border-collapse:collapse">
<tr><td><i>integer</i></td><td><i>particleSystemId</i></td><td>particle system id</td></tr>
...
<br />
<b>Definition</b><br />
<blockquote><i>function setParticleSystemTimeScale(integer particleSystemId, float timeScale)</i></blockquote>
<br />
<b>Arguments</b><br />
<blockquote><table cellpadding="3" border="1" style="border-collapse:collapse">
<tr><td><i>integer</i></td><td><i>particleSystemId</i></td><td>particle system id</td></tr>
<tr><td><i>float</i></td><td><i>timeScale</i></td><td>time scale for the particle simulation</td></tr>
</table></blockquote>
<br />
<br /><br /><br />
...
<br />
<b>Definition</b><br />
<blockquote><i>function getEmitterShape(integer particleSystemId)</i></blockquote>
<br />
<b>Arguments</b><br />
<blockquote><table cellpadding="3" border="1" style="border-collapse:collapse">
<tr><td><i>integer</i></td><td><i>particleSystemId</i></td><td>particle system id</td></tr>
...
<b>Return Values</b><br />
<blockquote><table cellpadding="3" border="1" style="border-collapse:collapse">
<tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the emitter shape</td></tr>
</table></blockquote>
<br />
<br /><br /><br />
...
<br />
<b>Definition</b><br />
<blockquote><i>function setEmitterShape(integer particleSystemId, integer shapeId)</i></blockquote>
<br />
<b>Arguments</b><br />
<blockquote><table cellpadding="3" border="1" style="border-collapse:collapse">
<tr><td><i>integer</i></td><td><i>particleSystemId</i></td><td>particle system id</td></tr>
...
<br />
<b>Definition</b><br />
<blockquote><i>function getCCTCollisionFlags(integer characterIndex)</i></blockquote>
<br />
<b>Arguments</b><br />
<blockquote><table cellpadding="3" border="1" style="border-collapse:collapse">
<tr><td><i>integer</i></td><td><i>characterIndex</i></td><td>character index number</td></tr>
...
<a name="runtime_function_reference_destruction"></a><h2>Destruction Function Reference</h2><br /><h3>getHasDestructionShape</h3><b>Description</b><br /><blockquote>Returns if the given destruction shape index exists</blockquote><br /><b>Definition</b><br /><blockquote><i>function getHasDestructionShape(integer shapeId, integer destructionShapeIndex)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr><tr><td><i>integer</i></td><td><i>destructionShapeIndex</i></td><td>index of the destruction shape</td></tr></table></blockquote><br /><b>Return Values</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>boolean</i></td><td><i>hasShape</i></td><td>true if a shape with the given index exists, otherwise false</td></tr></table></blockquote><br /><br /><br /><br /><h3>getDestructionShapeWorldTranslation</h3><b>Description</b><br /><blockquote>Get world translation of the given destruction shape</blockquote><br /><b>Definition</b><br /><blockquote><i>function getDestructionShapeWorldTranslation(integer shapeId, integer destructionShapeIndex, boolean physicalPosition)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr><tr><td><i>integer</i></td><td><i>destructionShapeIndex</i></td><td>index of the destruction shape</td></tr><tr><td><i>boolean</i></td><td><i>physicalPosition</i></td><td>if true, the translation of the physics object is returned, otherwise the translation of the visual representation</td></tr></table></blockquote><br /><b>Return Values</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>float</i></td><td><i>x</i></td><td>x world coordinate</td></tr><tr><td><i>float</i></td><td><i>y</i></td><td>y world coordinate</td></tr><tr><td><i>float</i></td><td><i>z</i></td><td>z world coordinate</td></tr></table></blockquote><br /><br /><br /><br /><h3>destructionShapeLocalToWorld</h3><b>Description</b><br /><blockquote>Destruction shape local space to world space transformation</blockquote><br /><b>Definition</b><br /><blockquote><i>function destructionShapeLocalToWorld(integer shapeId, integer destructionShapeIndex, boolean physicalPosition, float x, float y, float z)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr><tr><td><i>integer</i></td><td><i>destructionShapeIndex</i></td><td>index of the destruction shape</td></tr><tr><td><i>boolean</i></td><td><i>physicalPosition</i></td><td>if true, the translation of the physics object is returned, otherwise the translation of the visual representation</td></tr><tr><td><i>float</i></td><td><i>x</i></td><td>x value of local position</td></tr><tr><td><i>float</i></td><td><i>y</i></td><td>y value of local position</td></tr><tr><td><i>float</i></td><td><i>z</i></td><td>z value of local position</td></tr></table></blockquote><br /><b>Return Values</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>float</i></td><td><i>x</i></td><td>x world coordinate</td></tr><tr><td><i>float</i></td><td><i>y</i></td><td>y world coordinate</td></tr><tr><td><i>float</i></td><td><i>z</i></td><td>z world coordinate</td></tr></table></blockquote><br /><br /><br /><br /><h3>destructionShapeWorldToLocal</h3><b>Description</b><br /><blockquote>Destruction shape world space to local space transformation</blockquote><br /><b>Definition</b><br /><blockquote><i>function destructionShapeWorldToLocal(integer shapeId, integer destructionShapeIndex, boolean physicalPosition, float x, float y, float z)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr><tr><td><i>integer</i></td><td><i>destructionShapeIndex</i></td><td>index of the destruction shape</td></tr><tr><td><i>boolean</i></td><td><i>physicalPosition</i></td><td>if true, the translation of the physics object is returned, otherwise the translation of the visual representation</td></tr><tr><td><i>float</i></td><td><i>x</i></td><td>x value of world position</td></tr><tr><td><i>float</i></td><td><i>y</i></td><td>y value of world position</td></tr><tr><td><i>float</i></td><td><i>z</i></td><td>z value of world position</td></tr></table></blockquote><br /><b>Return Values</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>float</i></td><td><i>x</i></td><td>x value of local position</td></tr><tr><td><i>float</i></td><td><i>y</i></td><td>y value of local position</td></tr><tr><td><i>float</i></td><td><i>z</i></td><td>z value of local position</td></tr></table></blockquote><br /><br /><br /><br /><h3>destructionShapeLocalDirectionToWorld</h3><b>Description</b><br /><blockquote>Destruction shape local space to world space transformation, only direction without translation</blockquote><br /><b>Definition</b><br /><blockquote><i>function destructionShapeLocalDirectionToWorld(integer shapeId, integer destructionShapeIndex, boolean physicalPosition, float x, float y, float z)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr><tr><td><i>integer</i></td><td><i>destructionShapeIndex</i></td><td>index of the destruction shape</td></tr><tr><td><i>boolean</i></td><td><i>physicalPosition</i></td><td>if true, the direction of the physics object is returned, otherwise the direction of the visual representation</td></tr><tr><td><i>float</i></td><td><i>x</i></td><td>x value of world direction</td></tr><tr><td><i>float</i></td><td><i>y</i></td><td>y value of world direction</td></tr><tr><td><i>float</i></td><td><i>z</i></td><td>z value of world direction</td></tr></table></blockquote><br /><b>Return Values</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>float</i></td><td><i>x</i></td><td>x value of local direction</td></tr><tr><td><i>float</i></td><td><i>y</i></td><td>y value of local direction</td></tr><tr><td><i>float</i></td><td><i>z</i></td><td>z value of local direction</td></tr></table></blockquote><br /><br /><br /><br /><h3>destructionShapeWorldDirectionToLocal</h3><b>Description</b><br /><blockquote>Destruction shape world space to local space transformation, only direction without translation</blockquote><br /><b>Definition</b><br /><blockquote><i>function destructionShapeWorldDirectionToLocal(integer shapeId, integer destructionShapeIndex, boolean physicalPosition, float x, float y, float z)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr><tr><td><i>integer</i></td><td><i>destructionShapeIndex</i></td><td>index of the destruction shape</td></tr><tr><td><i>boolean</i></td><td><i>physicalPosition</i></td><td>if true, the direction of the physics object is returned, otherwise the direction of the visual representation</td></tr><tr><td><i>float</i></td><td><i>x</i></td><td>x value of world direction</td></tr><tr><td><i>float</i></td><td><i>y</i></td><td>y value of world direction</td></tr><tr><td><i>float</i></td><td><i>z</i></td><td>z value of world direction</td></tr></table></blockquote><br /><b>Return Values</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>float</i></td><td><i>x</i></td><td>x value of local direction</td></tr><tr><td><i>float</i></td><td><i>y</i></td><td>y value of local direction</td></tr><tr><td><i>float</i></td><td><i>z</i></td><td>z value of local direction</td></tr></table></blockquote><br /><br /><br /><br /><h3>getDestructionShapeCenterOfMass</h3><b>Description</b><br /><blockquote>Get the destruction shape center of mass</blockquote><br /><b>Definition</b><br /><blockquote><i>function getDestructionShapeCenterOfMass(integer shapeId, integer destructionShapeIndex)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr><tr><td><i>integer</i></td><td><i>destructionShapeIndex</i></td><td>index of the destruction shape</td></tr></table></blockquote><br /><b>Return Values</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>float</i></td><td><i>x</i></td><td>x value of local position of the center of mass</td></tr><tr><td><i>float</i></td><td><i>y</i></td><td>y value of local position of the center of mass</td></tr><tr><td><i>float</i></td><td><i>z</i></td><td>z value of local position of the center of mass</td></tr></table></blockquote><br /><br /><br /><br /><h3>getDestructionShapeMass</h3><b>Description</b><br /><blockquote>Get the destruction shape mass</blockquote><br /><b>Definition</b><br /><blockquote><i>function getDestructionShapeMass(integer shapeId, integer destructionShapeIndex)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr><tr><td><i>integer</i></td><td><i>destructionShapeIndex</i></td><td>index of the destruction shape</td></tr></table></blockquote><br /><b>Return Values</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>float</i></td><td><i>mass</i></td><td>mass of the destruction shape</td></tr></table></blockquote><br /><br /><br /><br /><h3>getDestructionShapeLinearVelocity</h3><b>Description</b><br /><blockquote>Get world space destruction shape linear velocity</blockquote><br /><b>Definition</b><br /><blockquote><i>function getDestructionShapeLinearVelocity(integer shapeId, integer destructionShapeIndex)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr><tr><td><i>integer</i></td><td><i>destructionShapeIndex</i></td><td>index of the destruction shape</td></tr></table></blockquote><br /><b>Return Values</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>float</i></td><td><i>x</i></td><td>x value of velocity</td></tr><tr><td><i>float</i></td><td><i>y</i></td><td>y value of velocity</td></tr><tr><td><i>float</i></td><td><i>z</i></td><td>z value of velocity</td></tr></table></blockquote><br /><br /><br /><br /><h3>getDestructionShapeAngularVelocity</h3><b>Description</b><br /><blockquote>Get world space destruction shape angular velocity</blockquote><br /><b>Definition</b><br /><blockquote><i>function getDestructionShapeAngularVelocity(integer shapeId, integer destructionShapeIndex)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr><tr><td><i>integer</i></td><td><i>destructionShapeIndex</i></td><td>index of the destruction shape</td></tr></table></blockquote><br /><b>Return Values</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>float</i></td><td><i>x</i></td><td>x value of angular velocity</td></tr><tr><td><i>float</i></td><td><i>y</i></td><td>y value of angular velocity</td></tr><tr><td><i>float</i></td><td><i>z</i></td><td>z value of angular velocity</td></tr></table></blockquote><br /><br /><br /><br /><h3>getDestructionMaxDamage</h3><b>Description</b><br /><blockquote>Get the maximal damage each destruction shape of the shape can receive until it breaks</blockquote><br /><b>Definition</b><br /><blockquote><i>function getDestructionMaxDamage(integer shapeId)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr></table></blockquote><br /><b>Return Values</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>float</i></td><td><i>maxDamage</i></td><td>maximal damage</td></tr></table></blockquote><br /><br /><br /><br /><h3>getDestructionShapeDamage</h3><b>Description</b><br /><blockquote>Get the current damage value of the given destruction shape</blockquote><br /><b>Definition</b><br /><blockquote><i>function getDestructionShapeDamage(integer shapeId, integer destructionShapeIndex)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr><tr><td><i>integer</i></td><td><i>destructionShapeIndex</i></td><td>index of the destruction shape</td></tr></table></blockquote><br /><b>Return Values</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>float</i></td><td><i>damage</i></td><td>damage of the destruction shape</td></tr></table></blockquote><br /><br /><br /><br /><h3>getDestructionShapeDamageRatio</h3><b>Description</b><br /><blockquote>Get the current damage ratio [0,1] of the given destruction shape</blockquote><br /><b>Definition</b><br /><blockquote><i>function getDestructionShapeDamageRatio(integer shapeId, integer destructionShapeIndex)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr><tr><td><i>integer</i></td><td><i>destructionShapeIndex</i></td><td>index of the destruction shape</td></tr></table></blockquote><br /><b>Return Values</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>float</i></td><td><i>damageRatio</i></td><td>damageRatio [0,1] of the destruction shape</td></tr></table></blockquote><br /><br /><br /><br /><h3>addDestructionShapeDamage</h3><b>Description</b><br /><blockquote>Add damage to the given destruction shape</blockquote><br /><b>Definition</b><br /><blockquote><i>function addDestructionShapeDamage(integer shapeId, integer destructionShapeIndex, float damage)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr><tr><td><i>integer</i></td><td><i>destructionShapeIndex</i></td><td>index of the destruction shape</td></tr><tr><td><i>float</i></td><td><i>damage</i></td><td>amount of damage</td></tr></table></blockquote><br /><br /><br /><br /><h3>deleteDestructionShape</h3><b>Description</b><br /><blockquote>Delete the given destruction shape</blockquote><br /><b>Definition</b><br /><blockquote><i>function deleteDestructionShape(integer shapeId, integer destructionShapeIndex)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr><tr><td><i>integer</i></td><td><i>destructionShapeIndex</i></td><td>index of the destruction shape</td></tr></table></blockquote><br /><br /><br /><br /><h3>getNumDestructionJoints</h3><b>Description</b><br /><blockquote>Get the number of joints the given shape has</blockquote><br /><b>Definition</b><br /><blockquote><i>function getNumDestructionJoints(integer shapeId)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr></table></blockquote><br /><b>Return Values</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>numJoints</i></td><td>number of joints between the destruction shapes</td></tr></table></blockquote><br /><br /><br /><br /><h3>getNumRemainingDestructionJoints</h3><b>Description</b><br /><blockquote>Get the number of unbroken joints, the given shape currently has</blockquote><br /><b>Definition</b><br /><blockquote><i>function getNumRemainingDestructionJoints(integer shapeId)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr></table></blockquote><br /><b>Return Values</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>numRemainingJoints</i></td><td>number of unbroken joints between the destruction shapes</td></tr></table></blockquote><br /><br /><br /><br /><h3>addDestructionShapeForce</h3><b>Description</b><br /><blockquote>Add force to the given destruction shape</blockquote><br /><b>Definition</b><br /><blockquote><i>function addDestructionShapeForce(integer shapeId, integer destructionShapeIndex, float x, float y, float z)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr><tr><td><i>integer</i></td><td><i>destructionShapeIndex</i></td><td>index of the destruction shape</td></tr><tr><td><i>float</i></td><td><i>x</i></td><td>x value of world space force</td></tr><tr><td><i>float</i></td><td><i>y</i></td><td>y value of world space force</td></tr><tr><td><i>float</i></td><td><i>z</i></td><td>z value of world space force</td></tr></table></blockquote><br /><br /><br /><br /><h3>addDestructionShapeImpulse</h3><b>Description</b><br /><blockquote>Add impulse to the given destruction shape</blockquote><br /><b>Definition</b><br /><blockquote><i>function addDestructionShapeImpulse(integer shapeId, integer destructionShapeIndex, float x, float y, float z)</i></blockquote><br /><b>Arguments</b><br /><blockquote><table cellpadding="3" border="1" style="border-collapse:collapse"><tr><td><i>integer</i></td><td><i>shapeId</i></td><td>id of the shape</td></tr><tr><td><i>integer</i></td><td><i>destructionShapeIndex</i></td><td>index of the destruction shape</td></tr><tr><td><i>float</i></td><td><i>x</i></td><td>x value of world space impulse</td></tr><tr><td><i>float</i></td><td><i>y</i></td><td>y value of world space impulse</td></tr><tr><td><i>float</i></td><td><i>z</i></td><td>z value of world space impulse</td></tr></table></blockquote><br /><br /><br /><br /><a name="runtime_function_reference_spline"></a><h2>Spline Function Reference</h2>
<br />
...
<tr><td><i>bool</i></td><td><i>immediateUpdate (optional)</i></td><td>if set to true, the animation is updated immediately, otherwise it is only updated the next frame. For performance reasons, only set this to true if you really need the immediate update.</td></tr>
</table></blockquote>
<br />
<br /><br /><br />
...
<tr>
	<td class="list" valign="top"><i>Ctrl-W</i></td>
	<td class="list" valign="top">Replace Dialog (4.1.6 or later)</td>
</tr>
<tr>
...
<br />
<br /><br />
<a name="debugger"><h1 style="page-break-before:always">Debugger</h1></a>
...
<br />
<img src="images/debugger/baseScreen.png" border="0" style="width:auto; max-width:100%;"><br />
<br />

<a name="debugger_overview"><h2>Overview</h2></a>

The debugger lets you test and run your scripts by setting break points inside your code and analyzing the situation once reaching them. With its help you can avoid adding custom debug print calls to check for the assignment of variables or if a certain part of the code got reached. It is easy to use and follows known conventions for debugging environments.<br />
<br />
The user interface is divided in the following sections:<br />
<ul>
	<li><a href="#debugger_ui_menu">menu and toolbars</a></li>
	<li><a href="#debugger_ui_editor">main text editor panel</a> for editing your code files</li>
	<li><a href="#debugger_ui_file">file browser panel</a>, showing the contents of the current project</li>
	<li><a href="#debugger_ui_variable">variable overview panel</a>, showing all variable assignments and</li>
	<li><a href="#debugger_ui_additional">panel for additional information</a></li>
</ul>
<br />
You can move around each panel by dragging and dropping the corresponding title bar. You can resize the panel by pulling its borders. You can close panels you don't need by using the cross symbol on the upper right corner and make them reappear again through the <i>View</i>-menu.<br />
<br />
To actually use the remote debugger's functionality see section <a href="#debugger_tutorial">Tutorial</a>.<br />
<br />
Most actions described here require use of the left mouse button, for the remainder of the text clicking a button means using the left mouse button.<br />
In the last section the available <a href="#debugger_keys">keyboard short-cuts</a> are listed.<br />


<a name="debugger_ui"><h2>User Interface</h2></a>


<a name="debugger_ui_menu"><h3>Menu and Toolbars</h3></a>

The file menu lets you open and save files, create and switch between projects and exit the application. The view menu lets you show hidden parts of the user interface. There is also the option to reset the complete window layout. With the debug menu you can control your debugging sessions (see section <a href="#debugger_tutorial_debugging">Debugging</a> for details). The help menu finally directs you to further information on our website.<br />
The most common operations are directly accessible in the toolbars.<br />

<p><img src="images/debugger/menubar.png" border="0"></p>


<a name="debugger_ui_editor"><h3>Main text editor panel</h3></a>

The text editor panel shows you all currently opened source code files. You can toggle between different source files by clicking on the tabs at the top of the panel. To close a specific source file press the cross in this row on the right edge of the panel.<br />
If you have opened many files you can use the arrows on the left and right side to move the currently shown tabs or use the small down arrow to directly jump to a specific file.<br />
The editor behaves like a regular text editor that in addition automatically highlights script commands. You can use it to directly write your source code.<br />
<br />
The most important part in conjunction with debugging is the setup of breakpoints. To set a break point press the left mouse button on the grey vertical bar to the right of the line numbers. A red dot will appear and signal the presence of the break point. Click on it again to remove it. Please be aware that you can only set breakpoints in source code lines that represent a script statement.<br />

<p><img src="images/debugger/editorWindow.png" border="0"></p>


<a name="debugger_ui_file"><h3>File browser panel</h3></a>

<table>
	<tr>
		<td><table>
			<tr><td><img src="images/debugger/filesWindow.png" border="0"></td></tr>
		</table></td>
		<td valign="top">The file browser shows you the project directory tree. It only shows files with the following extensions: <i>.lua</i>, <i>.xml</i> and <i>.i3d</i> files. In the file browser you can open files for editing. <br />
If you made changes to files outside of the debugger you have to refresh this view in the context menu. You can access the context menu with a right mouse button click.</td>
	</tr>
</table>


<a name="debugger_ui_variable"><h3>Variable overview panel</h3></a>

This panel shows you all variables and its assigned values in the current state. <br />
There are two tabs with global and local variables. Global variables are accessible from any code part. Whenever you create a new variable that is not directly stored inside a table or specified as local, a new global variable is generated. Local variables are either parameters passed to a function or newly created variables with the local keyword.<br />
Both tabs show a list with the variable name, its assigned value and its type. The contents of tables can be opened by using the <i>+</i> symbol in the variable list. For these contents a string representation of each key is used as name. If the key is a table its content is not visible.<br />

<p><img src="images/debugger/variablesWindow.png" border="0"></p>


<a name="debugger_ui_additional"><h3>Additional information panel</h3></a>

<a name="debugger_ui_additional_callstack"><h4>Callstack tab</h4></a>

<table>
	<tr>
		<td><table>
			<tr><td><img src="images/debugger/callstackPanel.png" border="0"></td></tr>
		</table></td>
		<td valign="top">While debugging, the callstack tab shows you the stack of functions called, that result in the current position in the code. The topmost list item specifies the current position in the code. <br />
Each item in the list states the source code file and the position inside this file where the function call happened. Double clicking on an item results in opening this source code file at the specified position inside the text editor panel, the line is also marked by a green arrow on the left side.</td>
	</tr>
</table>

<a name="debugger_ui_additional_breakpoint"><h4>Breakpoint tab</h4></a>

<table>
	<tr>
		<td><table>
			<tr><td><img src="images/debugger/breakpointPanel.png" border="0"></td></tr>
		</table></td>
		<td valign="top">This tab shows a list of all set breakpoints. Double clicking on an item results in opening this source code file at the specified position inside the text editor panel, the line is also marked by a green arrow on the left side.</td>
	</tr>
</table>


<a name="debugger_ui_additional_output"><h4>Output tab</h4></a>

<table>
	<tr>
		<td><table>
			<tr><td><img src="images/debugger/outputPanel.png" border="0"></td></tr>
		</table></td>
		<td valign="top">The output tab shows the engine logging output. The output of your print commands is also shown there. <br />
Script error messages are printed in this log as well. Double clicking on an item results in opening this source code file at the specified position inside the text editor panel, the line is also marked by a green arrow on the left side.</td>
	</tr>
</table>


<a name="debugger_tutorial"><h2>Tutorial</h2></a>

<a name="debugger_tutorial_setup"><h3>Setup</h3></a>

To create a new remote debugger project use the file menu with <i>File / New Project...</i>. In the window that appears you have to specify the project settings. <br />

<table>
	<tr>
		<td><table>
			<tr><td><img src="images/debugger/newProject.png" border="0"></td></tr>
		</table></td>
		<td><ul>
			<li><b>Name:</b> Name of the project</li>
			<li><b>Location:</b> Location where the project file is saved</li>
			<li><b>Source Base:</b> Directory that is used as the root for all source files in the project</li>
			<li><b>Debug Port:</b> TCP/IP port number</li>
			<li><b>Command line:</b> Command to run the application</li>
			<li><b>Working Directory:</b> Directory where to run the application</li>
		</ul>
		<ul type="none">
			<li>In most cases the fields for <i>Location</i>, <i>Source Base</i> and <i>Working Directory</i> will show the same value.</li>
		</ul>
		</td>
	</tr>
</table>
<br />
To be able to debug your program the debugger has to connect to the running application. The easiest way to manage this is by specifying the <i>-autoConnectDebugger</i> command line option in the XML-file for your application. The XML-entry should look similar to this line:<br />
<pre>&lt;cmdline&gt;game.exe -script scripts/main.lua -name test -autoConnectDebugger&lt;/cmdline&gt;</pre>
The mentioned command line option is added by default if you start the application within the debugger. You can still use the debugger without the <i>autoConnectDebugger</i> command line option by pressing <i>F10</i> in the engine application. The status line at the bottom of the debugger will indicate the status of the connection to the game application.<br />



<a name="debugger_tutorial_debugging"><h3>Debugging</h3></a>

An important part of debugging are breakpoints. Whenever the script code execution reaches a code line with a breakpoint the execution paused. You can set breakpoints inside the text editor panel by clicking next to the code line number. A red dot will appear to show the position of the breakpoint. The code will be stopped before execution of the script statement in the current line. Please note that only lines with script statements can be used for breakpoints. To remove a breakpoint you can click on the red dot again.<br />

<table>
	<tr>
		<td><table>
			<tr><td><img src="images/debugger/debuggingToolbar.png" border="0"></td></tr>
		</table></td>
		<td valign="bottom">To control a debugging session you can use the <i>Debug</i>-toolbar, the corresponding menu items or keyboard shortcuts.</td>
	</tr>
</table>
To start a debugging session you need to launch the engine application. You can do this with the <i>Start</i> and <i>Stop</i>-commands.<br />
Once a breakpoint is reached during execution of the script code the engine application pauses. Now you can inspect the current engine state with the help of the <a href="#debugger_ui_variable">variable</a>, the <a href="#debugger_ui_additional_callstack">callstack</a> and the <a href="#debugger_ui_additional_output">output</a> panel.<br />
<br />
You can also pause the engine application at any point in time without a breakpoint with the <i>Break all</i>-command. This command is useful when you need to know what the engine application currently does.<br />
<br />
To let the program continue use the <i>Continue</i>-command.<br />
<br />

<a name="debugger_tutorial_stepping"><h3>Stepping</h3></a>

To further analyze the control flow of the script code and the change of variables you can also step the application on a line by line basis with the help of the <i>Step into</i>, <i>Step over</i>, and <i>Step out</i> commands. <br />
The functionality provided is, in short words:<br />
<ul>
	<li><i>Step out</i> - stop at the next script statement after the statement that called the current function</li>
	<li><i>Step into</i> - stop at the first script statement of the function to be called</li>
	<li><i>Step over</i> - stop at the next script statement in the current function</li>
</ul>
The current position in your code is always highlighted by a yellow arrow next to the line numbers. If you opened other files and don't know where the engine execution stopped you can always use the callstack and double click on its first entry and the code file will open in the text editor panel with the current line marked with a green arrow.<br />
<br />

The following screenshots show an example situation.<br />
<table cellpadding="5">
	<tr>
		<td><img src="images/debugger/exampleEditor.png" border="0" alt=""></td>
		<td valign="top"><table cellpadding="8">
			<tr><td><img src="images/debugger/exampleVariables.png" border="0" alt=""></td></tr>
			<tr><td><img src="images/debugger/exampleCallstack.png" border="0" alt=""></td></tr>
		</table></td>
	</tr>
</table>

The program is stopped at line 19 of the <i>test.lua</i> file. In the local variables panel we see that the two parameters of the function and the newly set variable with the parameter z are available. The callstack tells us, that we are currently in line 19, but also that the current function was called in line 9 from the current file. And again this function was called from line 52 of the <i>main.lua</i> source file. <br />
<br />
If we want to continue debugging we could use the <i>Step into</i> command which would lead us to line 27, the first line with a statement of the called function <i>third()</i>. The <i>Step over</i> command would result the engine application to pause at line 21. And the <i>Step out</i> command would finally run the same code but stop at line 11.<br />
Please note that line number 20 and 26 are no script statements and therefore you cannot set breakpoints on such lines.<br />
<br />



<a name="debugger_keys"><h2>Keyboard short-cuts</h2></a>
...
<tr>
	<td class="list" valign="top"><i>Ctrl-Alt-S</i></td>
	<td class="list" valign="top">Save all</td>
</tr>
<tr>
	<td class="list" align="left"><i>F5</i></td>
	<td class="list" align="left">Start/Continue debugging</td>
</tr>
<tr>
	<td class="list" valign="top"><i>Ctrl-F5</i></td>
	<td class="list" valign="top">Start without debugging</td>
</tr>
<tr>
	<td class="list" valign="top"><i>F6</i></td>
	<td class="list" valign="top">Stop debugging</td>
</tr>
<tr>
	<td class="list" valign="top"><i>F7</i></td>
	<td class="list" valign="top">Break all</td>
</tr>
<tr>
	<td class="list" valign="top"><i>F10</i></td>
	<td class="list" valign="top">Step over</td>
</tr>
<tr>
	<td class="list" valign="top"><i>F11</i></td>
	<td class="list" valign="top">Step into</td>
</tr>
<tr>
	<td class="list" valign="top"><i>Shift-F11</i></td>
	<td class="list" valign="top">Step out</td>
</tr>
</table>
...
<ul>
    ...
    <li><b>Custom Shader Parameter:</b> Use the attribute name 'customParameter_&lt;parameterName&gt;' with a string type to specify the value of a custom shader parameter. The values should be space separated.<br/>
